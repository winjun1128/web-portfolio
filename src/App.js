    ...
    <div className="App">
      ...
      <div className="port-container">
        ...
        <div className="port-info">
          ...
          <p><strong>🛠기술스택 : </strong>HTML, CSS, JS, React, Visual Studio Code, Git Hub</p>
      ...
      {/* 항상 펼친 역할 패널 */}
      <div className="port-role-container open">
      ...
      <div className="port-container">
        ...
        <div className="port-info">
          ...
          <p><strong>🛠기술스택 : </strong>HTML, CSS, JS, JSP, JAVA, Mybatis, Spring framework, Oracle, Apache Tomcat, Eclipse, Sql developer, Git Hub</p>
      ...
      <div className="port-container">
        ...
        <div className="port-info">
          ...
          <p><strong>🛠기술스택 : </strong>HTML, CSS, JS, React, JAVA, Mybatis, Spring framework, Oracle, Apache Tomcat, Eclipse, Sql developer, Git Hub</p>
