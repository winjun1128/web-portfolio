    ...
    <div className="App">
      ...
      <div className="port-container">
        ...
        <div className="port-info">
          ...
          <p><strong>📜서류 : </strong> <a href="https://drive.google.com/drive/folders/1suBwzDi1O1N3CcVDS6T5OsEaDoPXSQed?usp=drive_link">https://drive.google.com/drive/folders/1suBwzDi1O1N3CcVDS6T5OsEaDoPXSQed?usp=drive_link</a></p>
          <p>
            <button
      ...
      <div className="port-container">
        ...
        <div className="port-info">
          ...
          <p><strong>🛠사용기술 : </strong>Spring framework, Oracle</p>
          ...
          <p><strong>📜서류 : </strong> <a href="https://drive.google.com/drive/folders/1aswtGctU1i_SB-BtqomMlT-nRzEEdoES?usp=drive_link">https://drive.google.com/drive/folders/1aswtGctU1i_SB-BtqomMlT-nRzEEdoES?usp=drive_link</a></p>
          <p>
            <button
      ...
      <div id="role-2" className={`port-role-container ${showRole2 ? "open" : ""}`} aria-hidden={!showRole2}>
        <div className="port-role-inner">
          ...
          <div className="port-info">
            <p><strong>역할 : </strong>프로젝트페이지의 작업관리, 메모, 알림, 공지, 초대 기능 설계·구현</p>
          </div>
        </div>
      </div>
      ...
      <div className="port-container">
        ...
        <div className="port-info">
          ...
          <p><strong>🛠사용기술 : </strong>React, Spring framework, Oracle</p>
          ...
          <p><strong>📜서류 : </strong><a href="https://drive.google.com/drive/folders/1JUohMzJ4CzSZzFHrNzPOZ1BGD-aqGu3s?usp=drive_link">https://drive.google.com/drive/folders/1JUohMzJ4CzSZzFHrNzPOZ1BGD-aqGu3s?usp=drive_link</a></p>
          <p>
            <button
      ...
      <div id="role-3" className={`port-role-container ${showRole3 ? "open" : ""}`} aria-hidden={!showRole3}>
        <div className="port-role-inner">
          ...
          <div className="port-info">
            <p><strong>역할 : </strong>경로 페이지 전담 및 주유소/충전소 페이지 일부 구현</p>
          </div>
        </div>
      </div>
    </div>
